...
class ListaOrdenVencidasGravesService
{
    public function getOrdenesDeCausaVencidasGravesGeneral(Request $request, $idCausa)
    {
    ...
    public function getOrdenesVencidasGravesDeCausaProcurador(Request $request, $idCausa)
    {
        $now = Carbon::now('America/La_Paz');
        $fechaHora = $now->format('Y-m-d H:i:00');
    ...
    public function devuelveListaOrdenVencidasGraves(Request $request, $idCausa)
    {
        $tipoUsuario = Auth::user()->tipo;
        if ($tipoUsuario === TipoUsuario::PROCURADOR) {
            $ordenes = $this->getOrdenesVencidasGravesDeCausaProcurador($request, $idCausa);
        } else {
            $ordenes = $this->getOrdenesDeCausaVencidasGravesGeneral($request, $idCausa);
        }
        return $ordenes;
    }
}

...
class ListaOrdenDescargadasService
{
    public function getOrdenesDeCausaDescargadasGeneral(Request $request, $idCausa)
    {
        try {
            $query = Orden::select([
                'id',
    ...
    public function getOrdenesDescargadasDeCausaProcurador(Request $request, $idCausa)
    {
    ...
    public function devuelveListaOrdenDescargadas(Request $request, $idCausa)
    {
        $tipoUsuario = Auth::user()->tipo;
        if ($tipoUsuario === TipoUsuario::PROCURADOR) {
            $ordenes = $this->getOrdenesDescargadasDeCausaProcurador($request, $idCausa);
        } else {
            $ordenes = $this->getOrdenesDeCausaDescargadasGeneral($request, $idCausa);
        }
        return $ordenes;
    }
}

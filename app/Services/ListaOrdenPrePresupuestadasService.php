...
class ListaOrdenPrePresupuestadasService
{
    public function getOrdenesDeCausaPrePresupuestadasGeneral(Request $request, $idCausa)
    {
        try {
            $query = Orden::select([
                'id',
    ...
    public function getOrdenesPrePresupuuestadasDeCausaProcurador(Request $request, $idCausa)
    {
    ...
    public function devuelveListaOrdenPrePresupuestadas(Request $request, $idCausa)
    {
        $tipoUsuario = Auth::user()->tipo;
        if ($tipoUsuario === TipoUsuario::PROCURADOR) {
            $ordenes = $this->getOrdenesPrePresupuuestadasDeCausaProcurador($request, $idCausa);
        } else {
            $ordenes = $this->getOrdenesDeCausaPrePresupuestadasGeneral($request, $idCausa);
        }
        return $ordenes;
    }
}

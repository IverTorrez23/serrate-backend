...
class ListaOrdenPronuncioAbogadoService
{
    ...
    public function getOrdenesPronuncioAbogadoDeCausaProcurador(Request $request, $idCausa)
    {
    ...
    public function devuelveListaOrdenPronuncioAbogado(Request $request, $idCausa)
    {
        $tipoUsuario = Auth::user()->tipo;
        if ($tipoUsuario === TipoUsuario::PROCURADOR) {
            $ordenes = $this->getOrdenesPronuncioAbogadoDeCausaProcurador($request, $idCausa);
        } else {
            $ordenes = $this->getOrdenesDeCausaPronuncioAbogadoGeneral($request, $idCausa);
        }
        return $ordenes;
    }
}

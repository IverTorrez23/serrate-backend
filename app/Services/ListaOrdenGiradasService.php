...
class ListaOrdenGiradasService
{
    public function getOrdenesDeCausaGiradasGeneral(Request $request, $idCausa)
    {
        try {
            $query = Orden::select([
                'id',
    ...
    public function getOrdenesGiradasDeCausaProcurador(Request $request, $idCausa)
    {
    ...
    public function devuelveListaOrdenGiradas(Request $request, $idCausa)
    {
        $tipoUsuario = Auth::user()->tipo;
        if ($tipoUsuario === TipoUsuario::PROCURADOR) {
            $ordenes = $this->getOrdenesGiradasDeCausaProcurador($request, $idCausa);
        } else {
            $ordenes = $this->getOrdenesDeCausaGiradasGeneral($request, $idCausa);
        }
        return $ordenes;
    }
}

...
class ListaOrdenCuentaConciliadaService
{
    public function getOrdenesDeCausaCuentaConciliadaGeneral(Request $request, $idCausa)
    {
        try {
            $query = Orden::select([
                'id',
    ...
    public function getOrdenesCuentaConciliadaDeCausaProcurador(Request $request, $idCausa)
    {
    ...
    public function devuelveListaOrdenCuentaConciliadas(Request $request, $idCausa)
    {
        $tipoUsuario = Auth::user()->tipo;
        if ($tipoUsuario === TipoUsuario::PROCURADOR) {
            $ordenes = $this->getOrdenesCuentaConciliadaDeCausaProcurador($request, $idCausa);
        } else {
            $ordenes = $this->getOrdenesDeCausaCuentaConciliadaGeneral($request, $idCausa);
        }
        return $ordenes;
    }
}

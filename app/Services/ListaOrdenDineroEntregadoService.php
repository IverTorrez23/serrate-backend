...
class ListaOrdenDineroEntregadoService
{
    public function getOrdenesDeCausaDineroEntregadoGeneral(Request $request, $idCausa)
    {
        try {
            $query = Orden::select([
                'id',
    ...
    public function getOrdenesDineroEntregadoDeCausaProcurador(Request $request, $idCausa)
    {
    ...
    public function devuelveListaOrdenDineroEntregado(Request $request, $idCausa)
    {
        $tipoUsuario = Auth::user()->tipo;
        if ($tipoUsuario === TipoUsuario::PROCURADOR) {
            $ordenes = $this->getOrdenesDineroEntregadoDeCausaProcurador($request, $idCausa);
        } else {
            $ordenes = $this->getOrdenesDeCausaDineroEntregadoGeneral($request, $idCausa);
        }
        return $ordenes;
    }
}

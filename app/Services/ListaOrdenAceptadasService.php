...
class ListaOrdenAceptadasService
{
    public function getOrdenesDeCausaAceptadasGeneral(Request $request, $idCausa)
    {
        try {
            $query = Orden::select([
                'id',
    ...
    public function getOrdenesAceptadasDeCausaProcurador(Request $request, $idCausa)
    {
    ...
    public function devuelveListaOrdenAceptadas(Request $request, $idCausa)
    {
        $tipoUsuario = Auth::user()->tipo;
        if ($tipoUsuario === TipoUsuario::PROCURADOR) {
            $ordenes = $this->getOrdenesAceptadasDeCausaProcurador($request, $idCausa);
        } else {
            $ordenes = $this->getOrdenesDeCausaAceptadasGeneral($request, $idCausa);
        }
        return $ordenes;
    }
}
